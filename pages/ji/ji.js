...
Page({
  ...
  loadCate: function (cateType, recordId) {
    ...
    wx.request({
      url: 'https://www.cwenshuo.com/liberty-web/account/category.htm',
      dataType: 'json',
      data: {
  ...
  addCateConfirm: function (e) {
    ...
    wx.request({
      url:   'https://www.cwenshuo.com/liberty-web/account/addCate.htm',
      dataType: 'json',
      data: {
        session: wx.getStorageSync('3rd_session'),
  ...
  submit: function (e) {
    ...
    wx.request({
      url:  'https://www.cwenshuo.com/liberty-web/account/saveRecord.htm',
      dataType: 'json',
      data: {
        session: wx.getStorageSync('3rd_session'),
        type: cateType,
  ...
  delCate:function(e){
    ...
    wx.request({
      url:  'https://www.cwenshuo.com/liberty-web/account/delCate.htm',
      data: {
